...
$(function() {
 ...
 /*   function containerHeight() {
        let availableHeight = $(window).height() - $('.page-container').offset().top - $('.navbar-fixed-bottom').outerHeight();
...
*/
   ...
   /* $('.has-children').dcDrilldown({
    ...
    $('.panel [data-action=reload]').click(function (e) {
        e.preventDefault();
        let block = $(this).parent().parent().parent().parent().parent();
        $(block).block({ 
    ...
    $('.category-title [data-action=collapse]').click(function (e) {
        e.preventDefault();
        let $categoryCollapse = $(this).parent().parent().parent().nextAll();
    ...
    $('.panel [data-action=collapse]').click(function (e) {
        e.preventDefault();
        let $panelCollapse = $(this).parent().parent().parent().parent().nextAll();
    ...
    $('.panel [data-action=close]').click(function (e) {
        e.preventDefault();
        let $panelClose = $(this).parent().parent().parent().parent().parent();
    ...
    $('.category-title [data-action=close]').click(function (e) {
        e.preventDefault();
        let $categoryClose = $(this).parent().parent().parent().parent();
