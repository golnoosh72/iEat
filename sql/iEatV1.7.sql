...
insert  into `customers`(`CustomerID`,`FullName`,`ProvinceID`,`POBox`,`Address`,`Phone`,`Mobile`,`Reward`,`UserName`,`UserPass`,`ActivityStatus`) values 
(1,'Mehran Ishanian',1,'H3H1Z2','125 Rene Levesque, App 401','5149296960','5149296960',0,'superadmin','Ad123456',1);
